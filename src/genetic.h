...
std::vector<Individual> crossover(std::function<double(std::vector<double> &)> func,std::function<std::vector<double>(const std::vector<double>&)> der, Individual ind1, Individual ind2, std::string algorithm);
